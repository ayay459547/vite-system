...
import type { CustomBadgeProps } from '@/components/feature' // 系統組件: 功能
import { CustomDivider, CustomMarkdown, CustomBadge, CustomButton } from '@/components/feature' // 系統組件: 功能
