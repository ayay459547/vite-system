...
import { VueFlow, FlowBackground, FlowPanel } from '@/components/chart'
...
<template>
  <div class="animation-layout-flow-test">
    <VueFlow
      v-model:nodes="nodes"
      v-model:edges="edges"
    ...
    >
      ...
      <FlowPanel class="process-panel" position="top-right">
        <div class="layout-panel">
          ...
          <button title="set horizontal layout" @click="layoutGraph('LR')">
            <Test_Icon name="horizontal" />
          </button>

          <button title="set vertical layout" @click="layoutGraph('TB')">
            <Test_Icon name="vertical" />
          </button>
        </div>
