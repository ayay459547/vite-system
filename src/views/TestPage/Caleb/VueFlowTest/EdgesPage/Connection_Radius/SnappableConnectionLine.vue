...
import { getBezierPath, useVueFlow, connectionExists } from '@/lib/lib_vueFlow'
...
watch([() => props.targetY, () => props.targetX], (_, __, onCleanup) => {
    ...
    connectionExists(
      {
        ...
        sourceHandle: (connectionStartHandle.value as any).handleId,
  ...
  if (closestHandle) {
    const el: any = document.querySelector(`[data-nodeid='${closestNode.node.id}']`)
