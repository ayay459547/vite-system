...
import { MarkerType } from '@/lib/lib_vueFlow'

import Test_CustomEdge from './Test_CustomEdge.vue'

const nodes = ref([
  {
    id: '1',
    position: { x: 0, y: 0 },
    data: { label: 'Select me for diamond markers' }
  },
  {
    id: '2',
    position: { x: 0, y: 150 },
    data: { label: 'Select me for circle markers' }
  },
...
<template>
  <div class="fill edge-markers-test">
    <VueFlow :nodes="nodes" :edges="edges" fit-view-on-init>
      <template #edge-custom="edgeProps">
        <Test_CustomEdge v-bind="edgeProps" />
      </template>
