...
import { CustomTabs, CustomButton, CustomModal, CustomEmpty, CustomLink } from '@/components/feature'
...
<template>
  <div class="process-view">
    ...
    >
      ...
      <template #footer>
        <div class="flex-row content-end i-ga-sm">
          ...
          <CustomButton
            type="success"
            :label="`${i18nTranslate(['setting', 'rushOrder'])}`"
            icon-name="check"
            icon-move="scale"
    ...
    <WebViewTable
      ref="webViewTableRef"
      webfuno="auto_114"
      designatedview="WebView_auto_114_erp"
