...
const throttleUpdateTransform = throttle(updateTransform, 8, { trailing: false }) as typeof updateTransform
...
.modal {
  ...
  &-header {
    ...
    line-height: 40px;
    overflow: hidden;
    border-bottom: 1.5px solid var(--el-text-color-disabled);
  ...
  &-footer {
    ...
    align-items: center;
    padding: 0 8px;
    border-top: 1.5px solid var(--el-text-color-disabled);
