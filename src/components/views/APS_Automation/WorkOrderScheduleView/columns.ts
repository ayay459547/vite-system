...
export const columnSetting = {
  ...
  status: {
    ...
    getI18nValue(data?: string | number): string {
      switch (data) {
        case 3:
        case '生產中':
        case '生產':
  ...
  /**
   * auto-38 使用
   * isStartDate_predefinedStartDate
   * isEndDate_predefinedCompleteDate
   */
  timeLineRange: {
    label: '時間區間',
    i18nLabel: 'timerange',
