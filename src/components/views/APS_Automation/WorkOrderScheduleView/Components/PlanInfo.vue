...
const init = async () => {
  ...
  if (statusProduct !== 'success') {
    swal({
      ...
      text: msgProduct ?? i18nTranslate('warning-contactIT', 'iPASP_common'),
  ...
  if (statusEngineeringWip !== 'success') {
    swal({
      icon: 'error',
      title: i18nTranslate('error-getData', 'iPASP_common'),
      text: msgEngineeringWip ?? i18nTranslate('warning-contactIT', 'iPASP_common'),
      showCancelButton: false
    })
  }
  ...
  if (statusPn !== 'success') {
    swal({
      icon: 'error',
      title: i18nTranslate('error-getData', 'iPASP_common'),
      text: msgPn ?? i18nTranslate('warning-contactIT', 'iPASP_common'),
      showCancelButton: false
    })
  }
