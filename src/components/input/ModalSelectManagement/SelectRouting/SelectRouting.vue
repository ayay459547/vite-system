...
import { useRouteInfo } from '@/declare/declare_routing/useRouteInfo'
import { columnSetting, linkSetting } from '@/declare/declare_routing/columns'
...
<template>
  <div class="i-page">
    <WebViewTable
      ...
      :fake-data="[]"
      fake-data-path="/declare/routing_fakeData.json"
      :is-mounted-init="false"
      @select="onSelect"
      @select-all="onSelectAll"
      @mounted="onWebViewTableMounted"
    >
      <template #column-routeId="{ data, prop }">
        <CustomLink
          :label="data"
          :data="data"
