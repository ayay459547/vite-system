...
import { useProductCustomerInfo } from '@/declare/declare_product/customer/useProductCustomerInfo'
import { columnSetting } from '@/declare/declare_product/customer/columns'
...
const tableOptions: TableOptions = {
  ...
  i18nModule: 'system',
  version: '1.2.0',
  settingKey: 'ModalSelect_productCustomer',
  rowKey: 'rowId',
  isSorting: true,
  selection: true,
  selectable: (row: any) => {
...
<template>
  <div class="i-page">
    <WebViewTable
      ...
      :fake-data="[]"
      fake-data-path="/declare/productCustomer_fakeData.json"
