...
import { useSpecCommonInfo } from '@/declare/declare_spec/specCommon/useSpecCommonInfo'
import { linkSetting } from '@/declare/declare_spec/specCommon/columns'
import { columnSetting } from '@/declare/declare_spec/specCommon/columns'
...
<template>
  <div class="i-page">
    <WebViewTable
      ...
      :fake-data="[]"
      fake-data-path="/declare/spec/specCommon_fakeData.json"
