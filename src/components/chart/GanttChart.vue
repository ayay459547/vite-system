...
const dateFormatter = (value: number, format: string) => {
  ...
  const mintes = (date.getMinutes() + 1).toString().padStart(2, '0')
...
export default defineComponent({
  ...
  props: {
        ...
        return [
          {
            type: 'type1',
            list: [
              [1496924100000, 1496914000000, 'title1', 'MEF-N1237551'],
              [1496924200000, 1496924000000, 'title2', 'MEF-N1237552'],
              [1496924300000, 1496934000000, 'title3', 'MEF-N1237553']
            ]
          },
          {
            type: 'type2',
            list: [
              [1496924100000, 1496914000000, 'title11', 'MEF-N1237551'],
              [1496924200000, 1496924000000, 'title22', 'MEF-N1237552'],
              [1496924300000, 1496934000000, 'title33', 'MEF-N1237553']
            ]
          }
        ]
      }
    ...
    barTextCallback: {
      type: Function,
      default: (value: any, title: string) => { return title },
      description: '自訂甘特圖的條狀 顯示的文字 有給value值 標題'
    },
    barColorCallback: {
        type: Function,
        default: (value: any) => { return '#3073ac' },
  ...
  setup (props, context) {
              ...
              xAxis: {
                  ...
                  axisLabel: {
                      ...
                      formatter: function (value: any, index: number) {
                          return dateFormatter(value, props.dateFormatX)
                      }
                  }
              },
              yAxis: {
              ...
              series: [
                  {
                      ...
                      tooltip: {
                          ...
                          formatter: function (params: any, api) {
                              ...
                              const start = dateFormatter(params.value[GANTT_START_TIME_INDEX], 'YYYY/MM/DD hh:mm:ss')
                              const end = dateFormatter(params.value[GANTT_COMPLETE_TIME_INDEX], 'YYYY/MM/DD hh:mm:ss')
      ...
      function renderGanttItem (params: any, api: any) {
          ...
          const text =
              barLength > valueWidth + 40 && x + barLength >= 270
              ? tempText
              : ''
