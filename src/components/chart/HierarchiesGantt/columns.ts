  ...
  status: {
    ...
    filter: {
      ...
      options: [
        ...
        { i18nLabel: 'gantt-state-0', label: '未開工', value: '0' },
        { i18nLabel: 'gantt-state-1', label: '已結清', value: '1' },
        { i18nLabel: 'gantt-state-2', label: '已完工', value: '2' },
        { i18nLabel: 'gantt-state-3', label: '生產中', value: '3' },
        { i18nLabel: 'gantt-state-4', label: '已發放', value: '4' },
        { i18nLabel: 'gantt-state-5', label: '未發放', value: '5' },
        { i18nLabel: 'gantt-state-6', label: '暫緩', value: '6' },
        { i18nLabel: 'gantt-state-999', label: '結案', value: '999' }
      ]
    }
  },
  productId: {
